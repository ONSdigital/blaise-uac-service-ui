            ...
            <main id="main-content" className="ons-page__main ons-u-mt-no">
                {
                    (
                        <>
                            <h1 className="u-mb-l">
                                Are you sure you want to enable UAC <span><em className="highlight">{uac}</em> with case ID <em className="highlight">{case_id}</em> from questionnaire <em className="highlight">{questionnaireName}</em></span> ?
                            </h1>
                            <br />
                            <ONSButton
                                label="Continue"
